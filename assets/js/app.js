...
function sidebarClick(id) {
  ...
  layer.fire("click");
/*Ocultar barra e ir al mapa en pantallas pequeñas  */
...
function syncSidebar() {
  /* Las funciones de la barra lateral vacíos  */
  $("#feature-list tbody").empty();
  /* Bucle a través de la capa de teatros y añadir sólo las características que se encuentran en los límites del mapa */
  ...
  /*Bucle a través de la capa de museos y añadir sólo las características que se encuentran en los límites del mapa */
  ...
  /* Actualización list.js lista de funciones*/
...
/* Una capa de clúster marcador para contener todos los grupos  */
...
/*  Marcador de posición capa de vacío Para añadir a la capa de control para escuchar cuándo agregar / quitar los cines a capa markerClusterer  */
...
var baseLayers = {
  "Mapa de la calle": mapquestOSM,
 
};

var groupedOverlays = {
  "Puntos de interes": {
    "<img src='assets/img/theater.png' width='24' height='28'>&nbsp;Hoteles": theaterLayer,
    "<img src='assets/img/museum.png' width='24' height='28'>&nbsp;Retaurantes": museumLayer
  },
  "Referencias": {
    "condados": boroughs,
    "Lineas del metro": subwayLines
  }
};
...
$(document).one("ajaxStop", function () {
  ...
  $("#searchbox").typeahead({
    ...
    templates: {
      header: "<h4 class='typeahead-header'><img src='assets/img/museum.png' width='24' height='28'>&nbsp;Restaurantes</h4>",
      suggestion: Handlebars.compile(["{{name}}<br>&nbsp;<small>{{address}}</small>"].join(""))
    }
  }, {
    name: "GeoNames",
